...
import { CanvasRevealEffect } from "@/components/ui/CanvasRevue";
  ...
  return (
    <section  className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card title="Planning and stratigies" icon={<AceternityIcon order='phase 1'/>}
        description='dfsy we sillo pmm,hjklo pmiiiu '
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card title="Development and Progress Update" icon={<AceternityIcon  order='phase 2'/>} description='dfsy we sillo pmm,hjklo pmiiiu '>
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="Development and Lunch " icon={<AceternityIcon order='phase 3' />} description='dfsy we sillo pmm,hjklo pmiiiu '>
          <CanvasRevealEffect
            animationSpeed={3}
